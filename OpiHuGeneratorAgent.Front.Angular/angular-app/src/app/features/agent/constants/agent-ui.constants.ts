export const AgentUiText = {
  agentTitle: 'OPI-HU',
  agentName: 'Agente OPI-HU',
  historySearch: 'Buscar en historial...',
  inputPlaceholder: 'Escribe el requerimiento, flujo, descripcion funcional o feedback para refinar esta fase...',
  ...
  missingInput: 'Pega primero un requerimiento, flujo o descripcion funcional.',
  generationError: 'No se pudo generar la respuesta.',
  openConversationError: 'No se pudo abrir la conversacion.',
  degeneratedOutputError: 'La IA genero texto repetido sin sentido. Intenta de nuevo con Generar epica OPI.',
  thinking: 'Pensando...',
  writing: 'Escribiendo...',
  errorStatus: 'Error',
